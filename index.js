...
function calculateMortgagePayment() {
  ...
  //   const lengthOfLoan = lengthOfLoanInput.value * 12; // konwersja na miesiące
  //   const interestRate = interestRateInput.value;
  //   const calculedInterest = 2.1 / 100; // konwersja na procenty
  //   const interesPreparado = calculedInterest / 12; // oprocentowanie miesięczne - zmieni na monthlyInterest

  //   const percentage = interesPreparado; // 0.065 / 12 = 6.5% / 12
  //   const percentagePlusOne = interesPreparado + 1;
  //   const exponentiationOperator = percentagePlusOne ** lengthOfLoan; // zmienic na math.pow
  ...
  resutlMortgage.textContent = "Pierwsza rata: " + interestRate;
